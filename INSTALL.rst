========================================================================
** Makanai ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **Makanai** in your system. 
...
To install **Makanai** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/makanai.git#egg=makanai

The above command will install the latest development release of **Makanai**.
